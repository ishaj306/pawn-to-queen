...
import type { ChessData } from "@/features/chess-data/actions";
import { GoldStar, Crown, Fleur } from "@/components/shared/decor";
...
// ─── Page ───
export default function DashboardClient({ initialData }: { initialData: ChessData }) {
  const user = useAuthStore((s) => s.user);
  const profile = useAuthStore((s) => s.profile);

  const { data, stats, loading } = useChessData(initialData);
